...
export default function Listing() {
  ...
  return (
    <main>
      ...
      <div
        className="fixed top-[13%] right-[3%] z-10 bg-white cursor-pointer border-2 border-gray-400 rounded-full w-12
      ...
      <div className="m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5">
        ...
        <div className="bg-blue-300 w-full h-[200px] lg-[400px] z-10 overflow-x-hidden">Map</div>
      </div>
    </main>
  );
}
